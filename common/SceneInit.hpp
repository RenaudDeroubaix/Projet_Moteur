...
void makeScene_0(Scene* s, const unsigned int SCR_WIDTH, const unsigned int SCR_HEIGHT){
   ...
   // s->get_data(player)->calculateBoundingBox();
    ...
    s->get_data(cloison5)->set_color(glm::vec3(0.5f,0.0,0.0)); 
    ...
    s->get_data(cloison7)->set_color(glm::vec3(0.5f,0.0,0.0)); 
    ...
    ChampVision CVnpc7 = ChampVision(s->get_data(npc7)->getpos() , s->get_data(npc7)->get_front() , 1.f * s->get_data(npc7)->getscale()  , 10.f * s->get_data(npc7)->getscale(), 1.f * s->get_data(npc7)->getscale()); // rayon , hauteur , rayon au sol
...
void makeScene_3(Scene* s, const unsigned int SCR_WIDTH, const unsigned int SCR_HEIGHT){
    s->resetscene();
