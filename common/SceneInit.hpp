...
void makeScene_0(Scene* s, const unsigned int SCR_WIDTH, const unsigned int SCR_HEIGHT){
    ...
    s->setposnode(lumiere1 , glm::vec3(16.f , 4.f , -0.f));
...
*/
    ...
    s->setposnode(lumiere2 , glm::vec3(-16.f , 4.f , -5.f ));
...
void makeScene_3(Scene* s, const unsigned int SCR_WIDTH, const unsigned int SCR_HEIGHT){
    ...
    Node* lumiere1 = s->make_node_light(true,false , 0);
    sol->addChild(lumiere1);
    s->setposnode(lumiere1 , glm::vec3(10.f , 4.f , -20.f));
    s->setcolornode(lumiere1 , glm::vec3(1.f , 0.4f , 0.4f)); 
    sol->addChild(lumiere1);
    /////// light2
    Node* lumiere2 = s->make_node_light(true,false , 0);    
    s->setposnode(lumiere2 , glm::vec3(5.f , 4.f , 20.f) );
